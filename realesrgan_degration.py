...
if __name__ == '__main__':
    ...
    # 使用示例：遍历多个文件夹
    folder1_path = "/home/aimll/mot/data/Dataset/mot/DanceTrack"

    image_list1 = get_image_list(folder1_path)
    # file_path = 'output.txt'
    # file = open(file_path, 'w')
    # list_str = '\n'.join(map(str, image_list1))
    # file.write(list_str)
    # file.close()

    for i in image_list1:
        t = RealESRGANDatadegration(i)
        result = t.synthesis()
        torchvision.utils.save_image(result, i)
